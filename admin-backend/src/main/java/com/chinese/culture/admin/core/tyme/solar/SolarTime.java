...
public class SolarTime extends AbstractTyme {
   ...
   * 公历日
   */
  protected com.chinese.culture.admin.core.tyme.solar.SolarDay day;
  ...
  public SolarTime(int year, int month, int day, int hour, int minute, int second) {
    ...
    this.day = com.chinese.culture.admin.core.tyme.solar.SolarDay.fromYmd(year, month, day);
    this.hour = hour;
    this.minute = minute;
    this.second = second;
  }
   ...
   * @return 公历日
   */
  public com.chinese.culture.admin.core.tyme.solar.SolarDay getSolarDay() {
    return day;
  }
   ...
   * @return 节气
   */
  public com.chinese.culture.admin.core.tyme.solar.SolarTerm getTerm() {
    int y = getYear();
    int i = getMonth() * 2;
    if (i == 24) {
      y += 1;
    ...
    com.chinese.culture.admin.core.tyme.solar.SolarTerm term = SolarTerm.fromIndex(y, i);
