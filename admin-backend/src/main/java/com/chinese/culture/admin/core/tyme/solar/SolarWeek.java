...
public class SolarWeek extends AbstractTyme {
  ...
  public int getIndexInYear() {
    int i = 0;
    com.chinese.culture.admin.core.tyme.solar.SolarDay firstDay = getFirstDay();
    // 今年第1周
  ...
  public SolarWeek next(int n) {
    ...
    if (n > 0) {
      ...
      while (d >= weekCount) {
        d -= weekCount;
        m = m.next(1);
        if (!com.chinese.culture.admin.core.tyme.solar.SolarDay.fromYmd(m.getYear(), m.getMonth(), 1).getWeek().equals(start)) {
          d += 1;
        }
   ...
   * @return 公历日
   */
  public com.chinese.culture.admin.core.tyme.solar.SolarDay getFirstDay() {
    com.chinese.culture.admin.core.tyme.solar.SolarDay firstDay = com.chinese.culture.admin.core.tyme.solar.SolarDay.fromYmd(getYear(), getMonth(), 1);
   ...
   * @return 公历日列表
   */
  public List<com.chinese.culture.admin.core.tyme.solar.SolarDay> getDays() {
    List<com.chinese.culture.admin.core.tyme.solar.SolarDay> l = new ArrayList<>(7);
