...
import com.chinese.culture.admin.common.core.iztro.calculator.LuckCalculator;
import com.chinese.culture.admin.common.core.iztro.calculator.StarConvergenceCalculator;
import com.chinese.culture.admin.common.core.iztro.calculator.PalaceRelationCalculator;
...
public class LimitInterpreter {
     ...
     * @return 大限运势解释
     */
    public static Map<String, Object> interpretMajorLimit(PalaceBO palace, int age, int fiveElementsClass) {
        ...
        // 2. 获取宫位吉凶分析
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult auspiciousness = PalaceAuspiciousnessAnalyzer.analyze(palace);
        ...
        // 添加吉凶分析
        desc.append(auspiciousness.getInterpretation());
     ...
     * @return 小限运势解释
     */
    public static Map<String, Object> interpretMinorLimit(PalaceBO palace, int age, boolean gender) {
        Map<String, Object> interpretation = new HashMap<>();
     ...
     * 分析宫位星耀组合
     */
    private static List<Map<String, Object>> analyzePalaceCombinations(PalaceBO palace) {
        ...
        for (int i = 0; i < allStars.size(); i++) {
            for (int j = i + 1; j < allStars.size(); j++) {
                StarBO star1 = allStars.get(i);
                StarBO star2 = allStars.get(j);
     ...
     * @return 组合解释
     */
    public static String getMajorLimitYearlyCombo(PalaceBO majorLimitPalace, PalaceBO yearlyPalace) {
        ...
        // 2. 分析吉凶组合
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult majorResult = PalaceAuspiciousnessAnalyzer.analyze(majorLimitPalace);
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult yearlyResult = PalaceAuspiciousnessAnalyzer.analyze(yearlyPalace);

        int majorScore = (int) majorResult.getScore();
        int yearlyScore = (int) yearlyResult.getScore();
     ...
     * @return 组合解释
     */
    public static String getMinorLimitYearlyCombo(PalaceBO minorLimitPalace, PalaceBO yearlyPalace) {
        StringBuilder interpretation = new StringBuilder();
        ...
        // 2. 分析吉凶组合
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult minorResult = PalaceAuspiciousnessAnalyzer.analyze(minorLimitPalace);
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult yearlyResult2 = PalaceAuspiciousnessAnalyzer.analyze(yearlyPalace);

        // 安全地获取并转换分数
        int minorScore = minorResult != null ? minorResult.getScore() : 0;
        int yearlyScore = yearlyResult2 != null? yearlyResult2.getScore() : 0;
