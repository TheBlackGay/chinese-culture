...
import com.chinese.culture.admin.core.tyme.culture.Ten;
import com.chinese.culture.admin.core.tyme.culture.Sound;
import com.chinese.culture.admin.core.tyme.culture.pengzu.PengZu;
...
public class SixtyCycle extends LoopTyme {
   ...
   * @return 天干
   */
  public com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem getHeavenStem() {
    return com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem.fromIndex(index % HeavenStem.NAMES.length);
  }
