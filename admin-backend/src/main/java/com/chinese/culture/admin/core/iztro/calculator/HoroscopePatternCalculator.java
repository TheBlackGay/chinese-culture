...
public class HoroscopePatternCalculator {
     ...
     * @return 格局列表及其解释
     */
    public static List<Map<String, Object>> calculatePatterns(List<Palace> palaces) {
     ...
     * 检查命宫格局
     */
    private static void checkMingGongPattern(Palace mingGong, List<Map<String, Object>> patterns) {
        // 检查命宫是否有主星
    ...
    private static void checkThreeNoblePattern(List<Palace> palaces, List<Map<String, Object>> patterns) {
        for (Palace palace : palaces) {
            int nobleCount = 0;
            for (Star star : palace.getMinorStars()) {
    ...
    private static void checkFourEvilPattern(List<Palace> palaces, List<Map<String, Object>> patterns) {
        for (Palace palace : palaces) {
            int evilCount = 0;
            for (Star star : palace.getAdjectiveStars()) {
     ...
     * 判断是否为重要宫位
     */
    private static boolean isImportantPalace(Palace palace) {
