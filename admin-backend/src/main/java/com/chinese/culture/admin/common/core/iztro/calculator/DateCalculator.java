...
public class DateCalculator {
     ...
     * @return 阴历日期
     */
    public RawDateBO.LunarDate solar2lunar(RawDateBO.SolarDate solarDate) {
        try {
            // 将阳历日期转换为LunarDay对象
            ...
            // 创建阴历日期对象
            RawDateBO.LunarDate lunarDate = new RawDateBO.LunarDate();
     ...
     * @return 阳历日期
     */
    public RawDateBO.SolarDate lunar2solar(RawDateBO.LunarDate lunarDate) {
        try {
            // 将阴历日期转换为SolarDay对象
     ...
     * @return 中国日期
     */
    public RawDateBO.ChineseDate getChineseDate(RawDateBO.SolarDate solarDate, int timeIndex) {
        try {
            // 将阳历日期转换为SolarDay对象
            SolarDay solarDay = SolarDay.fromYmd(solarDate.getYear(), solarDate.getMonth(), solarDate.getDay());
            LunarDay lunarDay = solarDay.getLunarDay();
            ...
            // 创建中国日期对象
            RawDateBO.ChineseDate chineseDate = new RawDateBO.ChineseDate();
            ...
            chineseDate.setSolarDay(solarDay);
            chineseDate.setLunarDay(lunarDay);
