...
public class HourlyFortuneTeller {
     ...
     * @return 流时运势预测结果
     */
    public static Map<String, Object> predictHourlyFortune(List<PalaceBO> palaces,
        ...
        // 2. 找到流时所在宫位
        PalaceBO hourlyPalace = findPalaceByBranch(palaces, hourlyFlow);
        result.put("hourlyPalace", hourlyPalace);

        // 3. 分析流时宫位吉凶
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult result2 = PalaceAuspiciousnessAnalyzer.analyze(hourlyPalace);
     ...
     * 生成流时运势描述
     */
    private static String generateHourlyDescription(PalaceBO palace, int score) {
     ...
     * 生成流时建议
     */
    private static String generateHourlySuggestion(PalaceBO palace, int score) {
