...
import com.chinese.culture.admin.core.tyme.LoopTyme;
import com.chinese.culture.admin.core.tyme.culture.Direction;
import com.chinese.culture.admin.core.tyme.culture.Element;
import com.chinese.culture.admin.core.tyme.culture.Zodiac;
import com.chinese.culture.admin.core.tyme.culture.pengzu.PengZuEarthBranch;
import com.chinese.culture.admin.core.tyme.enums.HideHeavenStemType;
import com.chinese.culture.admin.core.tyme.enums.YinYang;
...
public class EarthBranch extends LoopTyme {
   ...
   * @return 天干
   */
  public com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem getHideHeavenStemMain() {
    return com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem.fromIndex(new int[]{9, 5, 0, 1, 4, 2, 3, 5, 6, 7, 4, 8}[index]);
  }
   ...
   * @return 天干
   */
  public com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem getHideHeavenStemMiddle() {
    int n = new int[]{-1, 9, 2, -1, 1, 6, 5, 3, 8, -1, 7, 0}[index];
    return n == -1 ? null : com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem.fromIndex(n);
  }
   ...
   * @return 天干
   */
  public com.chinese.culture.admin.core.tyme.sixtycycle.HeavenStem getHideHeavenStemResidual() {
