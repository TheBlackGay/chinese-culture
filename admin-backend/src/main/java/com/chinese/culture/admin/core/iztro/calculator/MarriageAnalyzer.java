...
public class MarriageAnalyzer {
     ...
     * @return 婚姻感情分析结果
     */
    public static Map<String, Object> analyzeMarriage(List<Palace> palaces, 
                                                    int age,
                                                    boolean gender) {
        Map<String, Object> result = new HashMap<>();
        
        // 1. 找到夫妻宫
        Palace marriagePalace = findMarriagePalace(palaces);
     ...
     * 找到夫妻宫
     */
    private static Palace findMarriagePalace(List<Palace> palaces) {
     ...
     * 分析夫妻宫强度
     */
    private static int analyzeMarriagePalaceStrength(Palace palace) {
        if (palace == null) {
            return 0;
        }
     ...
     * 分析桃花运
     */
    private static Map<String, Object> analyzeRomance(List<Palace> palaces) {
        Map<String, Object> result = new HashMap<>();
        int score = 60; // 基础分
     ...
     * 分析婚姻时间
     */
    private static Map<String, Object> analyzeMarriageTiming(Palace palace,
                                                           int age,
                                                           boolean gender) {
        Map<String, Object> result = new HashMap<>();
     ...
     * 分析婚姻状况
     */
    private static Map<String, Object> analyzeMarriage(Palace marriagePalace, int age, boolean gender) {
        Map<String, Object> result = new HashMap<>();
        int score = 60; // 基础分
        
        // 分析主星
        for (Star star : marriagePalace.getMajorStars()) {
