...
public class PalaceRelationCalculator {
     ...
     * @return 三合宫位列表
     */
    public static List<Palace> getTrineRelations(Palace palace, List<Palace> allPalaces) {
        List<Palace> trineRelations = new ArrayList<>();
     ...
     * @return 四正宫位列表
     */
    public static List<Palace> getSquareRelations(Palace palace, List<Palace> allPalaces) {
        List<Palace> squareRelations = new ArrayList<>();
        EarthlyBranch branch = palace.getEarthlyBranch();
     ...
     * @return 对宫位置
     */
    public static Palace getOppositePalace(Palace palace, List<Palace> allPalaces) {
     ...
     * @return 关系类型
     */
    public static PalaceRelationType getRelationType(Palace palace1, Palace palace2) {
     ...
     * @return 关系效果描述
     */
    public static String getRelationEffect(Palace palace1, Palace palace2) {
     ...
     * @return 关系分析结果
     */
    public static Map<String, Object> analyzeAllRelations(Palace palace, List<Palace> allPalaces) {
        Map<String, Object> result = new HashMap<>();

        // 获取三方关系
        List<Palace> trineRelations = getTrineRelations(palace, allPalaces);
        List<String> trineEffects = new ArrayList<>();
        for (Palace p : trineRelations) {
            trineEffects.add(getRelationEffect(palace, p));
        }

        // 获取四正关系
        List<Palace> squareRelations = getSquareRelations(palace, allPalaces);
        List<String> squareEffects = new ArrayList<>();
        for (Palace p : squareRelations) {
            squareEffects.add(getRelationEffect(palace, p));
        }

        // 获取对宫关系
        Palace oppositePalace = getOppositePalace(palace, allPalaces);
    ...
    private static boolean isOpposite(Palace palace1, Palace palace2) {
        int index1 = palace1.getIndex();
        int index2 = palace2.getIndex();
        return Math.abs(index1 - index2) == 6;
    }

    private static boolean isTrine(Palace palace1, Palace palace2) {
        int index1 = palace1.getIndex();
        int index2 = palace2.getIndex();
    ...
    private static boolean isSextile(Palace palace1, Palace palace2) {
        int index1 = palace1.getIndex();
        int index2 = palace2.getIndex();
        int diff = Math.abs(index1 - index2);
    ...
    private static boolean isSquare(Palace palace1, Palace palace2) {
        int index1 = palace1.getIndex();
        int index2 = palace2.getIndex();
        int diff = Math.abs(index1 - index2);
    ...
    public static PalaceRelationType calculateRelation(Palace palace1, Palace palace2) {
