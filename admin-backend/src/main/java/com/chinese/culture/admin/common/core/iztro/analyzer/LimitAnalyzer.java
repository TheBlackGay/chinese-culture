...
public class LimitAnalyzer {
     ...
     * @return 大限分析结果
     */
    public static Map<String, Object> analyzeMajorLimit(List<PalaceBO> palaces,
                                                      int age,
        ...
        // 3. 找到大限宫位
        PalaceBO majorLimitPalace = findMajorLimitPalace(palaces, currentMajorLimit, gender);
     ...
     * @return 小限分析结果
     */
    public static Map<String, Object> analyzeMinorLimit(List<PalaceBO> palaces,
                                                      int age,
                                                      boolean gender) {
        Map<String, Object> result = new HashMap<>();
        ...
        // 2. 找到小限宫位
        PalaceBO minorLimitPalace = findMinorLimitPalace(palaces, currentMinorLimit, gender);
     ...
     * 找到大限宫位
     */
    private static PalaceBO findMajorLimitPalace(List<PalaceBO> palaces,
     ...
     * 找到小限宫位
     */
    private static PalaceBO findMinorLimitPalace(List<PalaceBO> palaces,
     ...
     * 分析宫位
     */
    private static Map<String, Object> analyzePalace(PalaceBO palace) {
        Map<String, Object> analysis = new HashMap<>();

        // 1. 分析宫位吉凶
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult result = PalaceAuspiciousnessAnalyzer.analyze(palace);
        analysis.put("score", result.getScore());
        analysis.put("level", result.getLevel());
        analysis.put("auspiciousFactors", result.getAuspiciousFactors());
        analysis.put("inauspiciousFactors", result.getInauspiciousFactors());
        analysis.put("suggestions", result.getSuggestions());
     ...
     * 生成大限运势描述
     */
    private static String generateMajorLimitDescription(PalaceBO palace,
        ...
        List<StarBO> majorStars = (List<StarBO>) analysis.get("majorStars");
     ...
     * 生成大限建议
     */
    private static String generateMajorLimitSuggestion(PalaceBO palace,
                                                       Map<String, Object> analysis,
                                                       int age) {
        if (palace == null) {
            return "";
     ...
     * 生成小限运势描述
     */
    private static String generateMinorLimitDescription(PalaceBO palace,
                                                        Map<String, Object> analysis) {
        if (palace == null) {
            return "小限宫位未找到";
        }
     ...
     * 生成小限建议
     */
    private static String generateMinorLimitSuggestion(PalaceBO palace,
                                                       Map<String, Object> analysis,
                                                       int age) {
        if (palace == null) {
            return "";
