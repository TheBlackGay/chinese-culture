package com.chinese.culture.admin.core.tyme.lunar;

import com.chinese.culture.admin.core.tyme.AbstractTyme;
import com.chinese.culture.admin.core.tyme.culture.Direction;
import com.chinese.culture.admin.core.tyme.culture.fetus.FetusMonth;
import com.chinese.culture.admin.core.tyme.culture.ren.MinorRen;
import com.chinese.culture.admin.core.tyme.culture.star.nine.NineStar;
import com.chinese.culture.admin.core.tyme.jd.JulianDay;
import com.chinese.culture.admin.core.tyme.lunar.LunarDay;
import com.chinese.culture.admin.core.tyme.lunar.LunarWeek;
import com.chinese.culture.admin.core.tyme.lunar.LunarYear;
...
import com.chinese.culture.admin.core.tyme.util.ShouXingUtil;
...
public class LunarMonth extends AbstractTyme {
   ...
   * 农历年
   */
  protected com.chinese.culture.admin.core.tyme.lunar.LunarYear year;
  ...
  protected LunarMonth(Object[] cache) {
    int m = (int) cache[1];
    this.year = com.chinese.culture.admin.core.tyme.lunar.LunarYear.fromYear((int) cache[0]);
  ...
  public LunarMonth(int year, int month) {
    com.chinese.culture.admin.core.tyme.lunar.LunarYear currentYear = com.chinese.culture.admin.core.tyme.lunar.LunarYear.fromYear(year);
    ...
    if (year > 8 && year < 24) {
      offset = 1;
    } else if (com.chinese.culture.admin.core.tyme.lunar.LunarYear.fromYear(year - 1).getLeapMonth() > 10 && year != 239 && year != 240) {
      offset = 3;
    }
   ...
   * @return 农历年
   */
  public com.chinese.culture.admin.core.tyme.lunar.LunarYear getLunarYear() {
    return year;
  }
   ...
   * @return 农历日列表
   */
  public List<com.chinese.culture.admin.core.tyme.lunar.LunarDay> getDays() {
    int size = getDayCount();
    int y = getYear();
    int m = getMonthWithLeap();
    List<com.chinese.culture.admin.core.tyme.lunar.LunarDay> l = new ArrayList<>(size);
   ...
   * @return 周列表
   */
  public List<com.chinese.culture.admin.core.tyme.lunar.LunarWeek> getWeeks(int start) {
    int size = getWeekCount(start);
    int y = getYear();
    int m = getMonthWithLeap();
    List<com.chinese.culture.admin.core.tyme.lunar.LunarWeek> l = new ArrayList<>(size);
