...
public class HoroscopeSuggestionGenerator {
     ...
     * @return 建议列表
     */
    public static List<Map<String, Object>> generateSuggestions(List<PalaceBO> palaces,
     ...
     * 根据宫位吉凶生成建议
     */
    private static void generatePalaceSuggestions(List<PalaceBO> palaces,
                                                List<Map<String, Object>> suggestions) {
        // 分析所有宫位
     ...
     * 根据星耀组合生成建议
     */
    private static void generateStarCombinationSuggestions(List<PalaceBO> palaces,
                                                         List<Map<String, Object>> suggestions) {
        // 获取所有星耀组合
