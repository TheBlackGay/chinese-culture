...
import com.chinese.culture.admin.core.tyme.culture.Taboo;
...
import com.chinese.culture.admin.core.tyme.culture.star.twelve.TwelveStar;
import com.chinese.culture.admin.core.tyme.eightchar.EightChar;
import com.chinese.culture.admin.core.tyme.eightchar.provider.EightCharProvider;
import com.chinese.culture.admin.core.tyme.eightchar.provider.impl.DefaultEightCharProvider;
...
public class LunarHour extends AbstractTyme {
   ...
   * 农历日
   */
  protected com.chinese.culture.admin.core.tyme.lunar.LunarDay day;
  ...
  public LunarHour(int year, int month, int day, int hour, int minute, int second) {
    ...
    this.day = com.chinese.culture.admin.core.tyme.lunar.LunarDay.fromYmd(year, month, day);
    this.hour = hour;
    this.minute = minute;
    this.second = second;
  }
   ...
   * @return 农历日
   */
  public com.chinese.culture.admin.core.tyme.lunar.LunarDay getLunarDay() {
    return day;
  }
