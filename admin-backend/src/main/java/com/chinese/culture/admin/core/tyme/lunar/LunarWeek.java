...
public class LunarWeek extends AbstractTyme {
  ...
  public LunarWeek next(int n) {
    ...
    if (n > 0) {
      ...
      while (d >= weekCount) {
        d -= weekCount;
        m = m.next(1);
        if (!com.chinese.culture.admin.core.tyme.lunar.LunarDay.fromYmd(m.getYear(), m.getMonthWithLeap(), 1).getWeek().equals(start)) {
          d += 1;
        }
   ...
   * @return 农历日
   */
  public com.chinese.culture.admin.core.tyme.lunar.LunarDay getFirstDay() {
    com.chinese.culture.admin.core.tyme.lunar.LunarDay firstDay = com.chinese.culture.admin.core.tyme.lunar.LunarDay.fromYmd(getYear(), getMonth(), 1);
  ...
  public List<com.chinese.culture.admin.core.tyme.lunar.LunarDay> getDays() {
    List<com.chinese.culture.admin.core.tyme.lunar.LunarDay> l = new ArrayList<>(7);
