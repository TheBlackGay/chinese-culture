...
import com.chinese.culture.admin.core.tyme.solar.SolarWeek;
...
public class SolarMonth extends AbstractTyme {
  ...
  public int getWeekCount(int start) {
    return (int) Math.ceil((indexOf(com.chinese.culture.admin.core.tyme.solar.SolarDay.fromYmd(getYear(), month, 1).getWeek().getIndex() - start, 7) + getDayCount()) / 7D);
  }
   ...
   * @return 周列表
   */
  public List<com.chinese.culture.admin.core.tyme.solar.SolarWeek> getWeeks(int start) {
    int size = getWeekCount(start);
    int y = getYear();
    List<com.chinese.culture.admin.core.tyme.solar.SolarWeek> l = new ArrayList<>(size);
  ...
  public List<com.chinese.culture.admin.core.tyme.solar.SolarDay> getDays() {
    ...
    int y = getYear();
    List<com.chinese.culture.admin.core.tyme.solar.SolarDay> l = new ArrayList<>(size);
