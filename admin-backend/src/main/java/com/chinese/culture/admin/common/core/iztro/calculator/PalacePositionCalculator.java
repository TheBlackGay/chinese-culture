...
public class PalacePositionCalculator {
     ...
     * @return 命宫地支
     */
    public static EarthlyBranch getMingGong(RawDateBO.LunarDate date, int timeIndex) {
     ...
     * @return 身宫地支
     */
    public static EarthlyBranch getShenGong(RawDateBO.LunarDate date, int timeIndex) {
