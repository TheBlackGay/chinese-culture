...
public class MonthlyDailyFortuneTeller {
     ...
     * @return 流月运势预测结果
     */
    public static Map<String, Object> predictMonthlyFortune(List<PalaceBO> palaces,
        ...
        // 2. 找到流月所在宫位
        PalaceBO monthlyPalace = findPalaceByBranch(palaces, monthlyFlow);
        result.put("monthlyPalace", monthlyPalace);

        // 3. 分析流月宫位吉凶
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult rest = PalaceAuspiciousnessAnalyzer.analyze(monthlyPalace);
        int score = rest.getScore();
     ...
     * @return 流日运势预测结果
     */
    public static Map<String, Object> predictDailyFortune(List<PalaceBO> palaces,
        ...
        // 2. 找到流日所在宫位
        PalaceBO dailyPalace = findPalaceByBranch(palaces, dailyFlow);
        result.put("dailyPalace", dailyPalace);

        // 3. 分析流日宫位吉凶
        PalaceAuspiciousnessAnalyzer.PalaceAuspiciousnessResult dayResult = PalaceAuspiciousnessAnalyzer.analyze(dailyPalace);
        int score = (int) dayResult.getScore();
        result.put("score", score);
     ...
     * 根据地支找到对应宫位
     */
    private static PalaceBO findPalaceByBranch(List<PalaceBO> palaces, EarthlyBranch branch) {
     ...
     * 生成流月运势描述
     */
    private static String generateMonthlyDescription(PalaceBO palace, int score) {
     ...
     * 生成流月建议
     */
    private static String generateMonthlySuggestion(PalaceBO palace, int score) {
     ...
     * 生成流日运势描述
     */
    private static String generateDailyDescription(PalaceBO palace, int score) {
        StringBuilder description = new StringBuilder();
     ...
     * 生成流日建议
     */
    private static String generateDailySuggestion(PalaceBO palace, int score) {
        StringBuilder suggestion = new StringBuilder();
