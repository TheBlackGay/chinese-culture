...
import com.chinese.culture.admin.dto.AstrolabeQueryDTO;
import com.chinese.culture.admin.service.impl.AstrolabeServiceImpl;
...
@SpringBootTest
public class AstrolabeServiceTest {

    private AstrolabeService astrolabeService;

    @BeforeEach
    void setUp() {
        astrolabeService = new AstrolabeServiceImpl();
    }

    @Test
    void testGetAstrolabe_WithSolarDate() {
        // 准备测试数据 - 阳历1990年8月15日寅时(3-5点)出生的男性
        AstrolabeQueryDTO queryDTO = new AstrolabeQueryDTO();
        ...
        // 执行测试
        Astrolabe astrolabe = astrolabeService.getAstrolabe(queryDTO);
    ...
    void testGetAstrolabe_InvalidBirthHour() {
        ...
        assertThrows(Exception.class, () -> {
            astrolabeService.getAstrolabe(queryDTO);
        });
    }
