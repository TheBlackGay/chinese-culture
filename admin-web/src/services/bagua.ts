...
// 六十四卦数据
export const hexagramData: { [key: string]: HexagramInfo } = {
  // 乾卦系列
  '111111': {
    name: '乾为天',
    meaning: '刚健中正',
  ...
  '001101': {
    name: '震雷离火',
    meaning: '动中有光',
    description: '雷声震动，火光照耀，象征动静结合，内外呼应。',
    analysis: '事业开拓创新，内外配合；感情热情奔放；投资积极进取；健康充满活力。',
    yaoChanges: {
      1: '震动初起，谨慎前行',
      2: '火光初现，明察秋毫',
      3: '内外呼应，动静相宜',
  ...
  '010110': {
    name: '水风井',
    meaning: '汲取、滋养',
    description: '水随风动，如同井水流动。象征滋养和补给，但需要适度汲取。',
    analysis: '事业需要持续投入；感情要互相滋养；投资讲究取舍；健康注意补给。',
    yaoChanges: {
      1: '井泥不食，旧井无禽',
      2: '井谷射鲋，瓮敝漏',
  ...
  '011100': {
    name: '泽山咸',
    meaning: '感应、交流',
    description: '泽水浸润山体，象征感应和交流。提示当前适合沟通和交往。',
    analysis: '事业需要交流；感情重在感应；投资讲究默契；健康保持平和。',
    yaoChanges: {
      1: '咸其拇',
      2: '咸其腓，凶，居吉',
      3: '咸其股，执其随，往吝',
